                        ...
                        <div class="panel">
                            ...
                            <form method="POST" action="ManageInformation">
                                <div class="panel-body">
                                    ...
                                    <br>
                                    <input type="text" readonly="readonly" class="form-control"
                                           value="${sessionScope.WorkAge}" name="workage">
                                    <br>
                                    年龄：
                                    <br>
                                    ...
                                    电话：
                                    <br>
                                    <input type="text" class="form-control" value="${sessionScope.PhoneNumber}"
                                           name="tele">
                                    <br>
                                    邮箱：
                                    <br>
                                    ...
                                    <br>
                                    <input type="text" readonly="readonly" class="form-control"
                                           value="${sessionScope.Job}" name="job">
                                    <br>
                                    岗位：
                                    <br>
                                    <input type="text" readonly="readonly" class="form-control"
                                           value="${sessionScope.DepID}" name="department">
                                    <br>
                                    性别：
                                    <br>
